		...
		struct PCAResult {
			...
			flattened() const {
				return {
					...
					principal_axis_span[0][0], principal_axis_span[0][1], principal_axis_span[0][2],
					principal_axis_span[1][0], principal_axis_span[1][1], principal_axis_span[1][2],
					axis_extremes[0][0][0], axis_extremes[0][0][1], axis_extremes[0][0][2],
					axis_extremes[0][1][0], axis_extremes[0][1][1], axis_extremes[0][1][2],
					axis_extremes[1][0][0], axis_extremes[1][0][1], axis_extremes[1][0][2],
					axis_extremes[1][1][0], axis_extremes[1][1][1], axis_extremes[1][1][2],
					axis_extremes[2][0][0], axis_extremes[2][0][1], axis_extremes[2][0][2],
					axis_extremes[2][1][0], axis_extremes[2][1][1], axis_extremes[2][1][2]
				};
			}
		};
