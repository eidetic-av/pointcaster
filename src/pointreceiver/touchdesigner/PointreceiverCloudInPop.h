...
class PointreceiverCloudInPOP : public TD::POP_CPlusPlusBase {
public:
  PointreceiverCloudInPOP(const TD::OP_NodeInfo *node_info,
                          TD::POP_Context *context);
  ~PointreceiverCloudInPOP() override;
...
private:
  ...
  std::shared_ptr<pr::td::PointreceiverChannelSubscription>
      _channel_subscription;
  ...
  std::array<float, 3> _last_published_centroid{0.0f, 0.0f, 0.0f};
